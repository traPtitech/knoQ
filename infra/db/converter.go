...
func ConvCreateRoomParamsToRoom(src domain.CreateRoomArgs) (dst Room) {
	dst.Verified = src.Verified
	dst.CreatedByRefer = src.CreatedBy
	dst.Place = src.Place
	dst.TimeStart = src.TimeStart
	dst.TimeEnd = src.TimeEnd
	dst.Admins = make([]RoomAdmin, len(src.Admins))
	for i := range src.Admins {
		dst.Admins[i] = convuuidUUIDToRoomAdmin(src.Admins[i])
	}
	return
}
...
func ConvUpdateRoomParamsToRoom(src domain.UpdateRoomArgs) (dst Room) {
	dst.CreatedByRefer = src.CreatedBy
	dst.Place = src.Place
	dst.TimeStart = src.TimeStart
	dst.TimeEnd = src.TimeEnd
...
func ConvWriteGroupParamsToGroup(src domain.UpsertGroupArgs) (dst Group) {
	dst.CreatedByRefer = src.CreatedBy
	dst.Name = src.Name
	dst.Description = src.Description
	dst.JoinFreely = src.JoinFreely
